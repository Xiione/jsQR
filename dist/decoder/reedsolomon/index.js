...
var g=p.ba.xa,r=g[b];void 0===r||void 0===r.ga&&r.className!==p.name&&r.Ea===c-2?(w.Ea=c-2,w.className=p.name,g[b]=w):(bb(g,b,x),g[b].ga[c-2]=w);M([],h,t=>{t=zb(x,t,p,f,k,n);void 0===g[b].ga?(t.Ea=c-2,g[b]=t):g[b].ga[c-2]=t;return []});return []});},D:a=>L(a,Db),k:(a,b,c)=>{b=N(b);L(a,{name:b,fromWireType:d=>d,toWireType:(d,e)=>e,argPackAdvance:8,readValueFromPointer:Eb(b,c),ka:null});},I:(a,b,c,d,e,f,k)=>{var l=wb(b,c);a=N(a);a=Ab(a);e=Q(d,e);cb(a,function(){vb(`Cannot call ${a} due to unbound types`,
...
Float32Array,Float64Array][b];c=N(c);L(a,{name:c,fromWireType:d,argPackAdvance:8,readValueFromPointer:d},{ub:!0});},n:a=>{L(a,Db);},l:(a,b)=>{b=N(b);var c="std::string"===b;L(a,{name:b,fromWireType:function(d){var e=E[d>>2],f=d+4;if(c)for(var k=f,l=0;l<=e;++l){var n=f+l;if(l==e||0==A[n]){k=k?U(A,k,n-k):"";if(void 0===h)var h=k;else h+=String.fromCharCode(0),h+=k;k=n+1;}}else {h=Array(e);for(l=0;l<e;++l)h[l]=String.fromCharCode(A[f+l]);h=h.join("");}R(d);return h},toWireType:function(d,e){e instanceof ArrayBuffer&&
