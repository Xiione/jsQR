...
c.exports;oa=Z.I;c=oa.buffer;h.HEAP8=t=new Int8Array(c);h.HEAP16=z=new Int16Array(c);h.HEAPU8=x=new Uint8Array(c);h.HEAPU16=qa=new Uint16Array(c);h.HEAP32=B=new Int32Array(c);h.HEAPU32=C=new Uint32Array(c);h.HEAPF32=ra=new Float32Array(c);h.HEAPF64=sa=new Float64Array(c);cb=Z.N;ua.unshift(Z.J);D--;h.monitorRunDependencies?.(D);0==D&&(E&&(c=E,E=null,c()));return Z}var b={a:Ic};D++;h.monitorRunDependencies?.(D);if(h.instantiateWasm)try{return h.instantiateWasm(b,
a)}catch(c){n(`Module.instantiateWasm callback failed with error: ${c}`),ba(c);}za||=h.locateFile?ya("rsiscool.wasm")?"rsiscool.wasm":h.locateFile?h.locateFile("rsiscool.wasm",fa):fa+"rsiscool.wasm":(new URL("rsiscool.wasm",import.meta.url)).href;Da(b,function(c){a(c.instance);}).catch(ba);return {}}(),ib=a=>(ib=Z.K)(a),Q=a=>(Q=Z.L)(a),Hc=a=>(Hc=Z.M)(a);h.dynCall_jiji=(a,b,c,d,e)=>(h.dynCall_jiji=Z.P)(a,b,c,d,e);h.dynCall_viijii=(a,b,c,d,e,f,l)=>(h.dynCall_viijii=Z.Q)(a,b,c,d,e,f,l);
